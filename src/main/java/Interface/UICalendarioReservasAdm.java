...
public class UICalendarioReservasAdm extends JFrame {
    ...
    public UICalendarioReservasAdm(ReservaController reservaController, UsuarioController usuarioController) {
    ...
    private void carregarCalendario() {
        ...
        ArrayList<Reserva> reservas = reservaController.getReservasAprovadas();
